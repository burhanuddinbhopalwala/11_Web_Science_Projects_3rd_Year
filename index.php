...
if(isset($submit))
{
	if( $email == "burhan2survey@gmail.com" && $password == "burhan")
	{
		$_SESSION['email']=$email;
		header('Location:./main_project/template/index.php');
	}
	else 
		echo "<center><strong>Incorrect Username or Password</strong></center>" ;
}
...
<!-- end-contact-form -->
<div class="footer">
	<p>Created by <a href="http://www.burhan.freeiz.com/">By Burhanuddin Bhopal Wala</a></p>
</div>
</div>
</body>
</html>